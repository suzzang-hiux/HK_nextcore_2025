 ...
 * @author PentaSystems
 * 
 * @property {Object} replaceHtm
 * 	@property {Function} replaceHtm.title [title]{@link module:PubEPUI~title}

 * @property {Object} dialog
 * 	@property {Function} dialog.closeDialog [closeDialog]{@link module:PubEPUI~closeDialog}
 * 	@property {Function} dialog.html [html]{@link module:PubEPUI~html}
 * 	@property {Function} dialog.frame [frame]{@link module:PubEPUI~frame}
 * 	@property {Function} dialog.frameHtml [frameHtml]{@link module:PubEPUI~frameHtml}
 * 	@property {Function} dialog._dialog [_dialog]{@link module:PubEPUI~_dialog}
 * 
 * @property {Function} pageCountList [pageCountList]{@link module:PubEPUI~pageCountList} <div style="color:red">※ 관리자 페이지 페이징 처리 시 사용</div>
 * 
 * @property {Object} toast
 * 	@property {Object} toast.options
 * 	@property {Function} toast.view [view]{@link module:PubEPUI~view}
 * 
 * @property {Object} module
 * 	@property {Function} module.selectBoxMove [selectBoxMove]{@link module:PubEPUI~selectBoxMove}
 * 	@property {Function} module.getSelectItem [getSelectItem]{@link module:PubEPUI~getSelectItem}
 * 	@property {Function} module.selectItemUpDown [selectItemUpDown]{@link module:PubEPUI~selectItemUpDown}
 * 
 * @property {Object} editor 네이버 스마트 에디터 사용시 editor 모듈 사용
 * 	@property {Object} editor._cacheEditorObject
 *	@property {Object} editor.defalutOptions
 *	@property {Function} editor._getElPlaceHolderID [_getElPlaceHolderID]{@link module:PubEPUI~_getElPlaceHolderID}
 * 	@property {Function} editor.create [create]{@link module:PubEPUI~create}
 *	@property {Function} editor.setConent [setConent]{@link module:PubEPUI~setConent}
 * 	@property {Function} editor.getConent [getConent]{@link module:PubEPUI~getConent}
 */
...
_$base.dialog={
	...
	,_dialog : function (mode , dialogInfo , opt){
		...
		if(mode=='frame'){
			...
			dialogHtm = '<iframe id="'+_targetId+'iframe" name="'+_targetId+'iframe" src="" style="text-align:center;width:'+options.width.replace('px','')+'px;height:'+options.height.replace('px','')+'px" frameborder="1" scrolling="'+options.scrolling+'"></iframe>'; 
 ...
 * @param {Object} opt
 * @desc pageCountList
 * @example PubEPUI.pageCountList('#countPerPageDivId')
 */	
...
_$base.module={
	 ...
	 * @param {String} selector   selecotr
	 * @param {Object} options   options
	 * @desc select box 모든 item 구하기.
	 */	
	...
	/**
	 * @method selectItemUpDown
	 * @param {String} selector  selecotr
	 * @param {String} type  이동할 타입 (위, 아래)
	 * @desc select box  move
	 */	
