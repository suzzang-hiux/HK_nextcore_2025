...
!(function (e, t) {
    "object" == typeof exports && "object" == typeof module
        ? (module.exports = t(require("survey-creator-core")))
        : "function" == typeof define && define.amd
        ? define("SurveyCreatorLocales", ["survey-creator-core"], t)
        : "object" == typeof exports
        ? (exports.SurveyCreatorLocales = t(require("survey-creator-core")))
        : (e.SurveyCreatorLocales = t(e.SurveyCreatorCore));
})(this, function (e) {
    return (function (e) {
        var t = {};
        function a(i) {
        ...
        function (e, t, a) {
            ...
            i.editorLocalization.locales.ar = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "حذف الشعار", left: "يسار", right: "يمين", top: "في الأعلى", bottom: "في الأسفل" },
                    tabs: {
                        general: "عام",
                ...
                ts: { selectPage: "Select the page to test it:", showInvisibleElements: "إظهار العناصر المخفية" },
                validators: { answercountvalidator: "answer count", emailvalidator: "بريد إلكتروني", expressionvalidator: "عملية حسابية", numericvalidator: "رقمية", regexvalidator: "تعبير رياضي", textvalidator: "النص" },
                triggers: {
            ...
            i.editorLocalization.locales.hr = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Uklanjanje logotipa", left: "Lijevo", right: "Desno", top: "Na vrhu", bottom: "Na dnu" },
                    tabs: {
                        general: "Općenito",
                ...
                ts: { selectPage: "Odaberite stranicu da biste je testirali:", showInvisibleElements: "Pokaži nevidljive elemente" },
                validators: { answercountvalidator: "broj odgovora", emailvalidator: "e-mail", expressionvalidator: "expression", numericvalidator: "numeric", regexvalidator: "regex", textvalidator: "text" },
                triggers: {
                ...
                p: {
                    name: "name",
                    title: { name: "title", title: "Ostavite prazno, ako je isto kao 'Name'" },
            ...
            i.editorLocalization.locales.cs = {
                ...
                p: { title: { title: "Nechte pole prázdné, pokud je stejné jako „Název”" } },
                pe: {
                    ...
                    logoPositions: { bottom: "Dole", left: "Vlevo", none: "Odstranit logo", right: "Vpravo", top: "Nahoře" },
                ...
                ts: { selectPage: "Vyberte stránku a otestujte ji:", showInvisibleElements: "Zobrazit neviditelné prvky" },
                validators: { answercountvalidator: "počet odpovědí", emailvalidator: "e-mail", expressionvalidator: "výraz", numericvalidator: "číselné", regexvalidator: "regex", textvalidator: "text" },
            };
            i.editorLocalization.locales.da = {
                ...
                validators: { answercountvalidator: "answer count", emailvalidator: "e-mail", expressionvalidator: "expression", numericvalidator: "numeric", regexvalidator: "regex", textvalidator: "text" },
                triggers: { completetrigger: "undersøgelse gennemført", setvaluetrigger: "sæt værdi", copyvaluetrigger: "kopiér værdi", runexpressiontrigger: "afvikl udtry", visibletrigger: "skift synlighed" },
                p: {
                    name: "navn",
                    title: { name: "titel", title: "Lad den være tom hvis det er det samme som 'Navn'" },
                    navigationButtonsVisibility: "navigationButtonsVisibility",
                    questionsOrder: "questionsOrder",
                    maxTimeToFinish: "maxTimeToFinish",
                    visible: "visible",
            ...
            i.editorLocalization.locales.nl = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Logo verwijderen", left: "Links", right: "Rechtsaf", top: "Bovenop", bottom: "Onder aan" },
                    tabs: {
                        general: "Algemeen",
                        fileOptions: "Opties",
                        html: "Html-editor",
                ...
                ts: { selectPage: "Selecteer de pagina om deze te testen:", showInvisibleElements: "Toon onzichtbare elementen" },
                validators: { answercountvalidator: "Aantal antwoorden", emailvalidator: "E-mail", expressionvalidator: "Uitdrukking", numericvalidator: "Numeriek", regexvalidator: "Regex", textvalidator: "Tekst" },
                triggers: {
                ...
                p: {
                    name: "Naam",
                    title: { name: "Titel", title: "Laat het leeg als het hetzelfde is als 'Naam'" },
            ...
            i.editorLocalization.locales.fi = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Poista logo", left: "Vasen", right: "Oikea", top: "Päällä", bottom: "Alla" },
                    tabs: {
                        general: "Yleinen",
                ...
                ts: { selectPage: "Valitse sivu testataksesi sitä:", showInvisibleElements: "Näytä näkymätön elementti" },
                validators: { answercountvalidator: "vastausten määrä", emailvalidator: "sähköposti", expressionvalidator: "lauseke", numericvalidator: "lukumääräinen", regexvalidator: "säännöllinen lauseke", textvalidator: "teksti" },
                triggers: {
                ...
                p: {
                    name: "nimi",
                    title: { name: "otsikko", title: "Jätä se tyhjäksi, jos se on sama kuin 'Nimi'" },
                    navigationButtonsVisibility: "navigationButtonsVisibility",
                    questionsOrder: "questionsOrder",
                    maxTimeToFinish: "maxTimeToFinish",
                    visible: "visible",
            ...
            i.editorLocalization.locales.fr = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Retirer le logo", left: "Gauche", right: "Droite", top: "Au dessus", bottom: "En dessous" },
                    tabs: {
                        general: "Général",
                        fileOptions: "Options",
                        html: "Éditeur HTML",
                ...
                ts: { selectPage: "Sélectionner une page pour la tester", showInvisibleElements: "Afficher les éléments invisibles" },
                validators: { answercountvalidator: "total de réponses", emailvalidator: "e-mail", numericvalidator: "numérique", regexvalidator: "regex", textvalidator: "texte" },
                triggers: {
                ...
                p: {
                    name: "Nom",
                    title: { name: "Titre", title: 'Laissez vide, si même texte que le "Nom"' },
            ...
            i.editorLocalization.locales.de = {
                survey: {
                    ...
                    drag: "Element ziehen",
                    license: "Bitte erwerben Sie eine Entwicklerlizenz für SurveyJS Creator, um diesen in Ihrer Anwendung verwenden zu können",
                },
                qt: {
                    default: "Standard",
                    checkbox: "Auswahl",
                ...
                pe: {
                    ...
                    logoPositions: { none: "ausblenden", left: "links", right: "rechts", top: "oben", bottom: "unten" },
                    tabs: {
                        general: "Allgemein",
                ...
                ts: { selectPage: "Seite:", showInvisibleElements: "Unsichtbare Elemente anzeigen" },
                validators: { answercountvalidator: "Antwortanzahl", emailvalidator: "E-Mail", expressionvalidator: "Ausdruck", numericvalidator: "Zahl", regexvalidator: "Regulärer Ausdruck", textvalidator: "Text" },
                triggers: {
            ...
            i.editorLocalization.locales.hu = {
                ...
                ts: { selectPage: "Válassza ki a tesztelni kívánt lapot:", showInvisibleElements: "Nemlátható elemek megjelnítése" },
                validators: { answercountvalidator: "válaszok száma", emailvalidator: "e-mail", expressionvalidator: "kifejezés", numericvalidator: "szám", regexvalidator: "reguláris kifejezés", textvalidator: "szöveg" },
                triggers: {
                ...
                p: {
                    name: "Megnevezés",
                    title: { name: "Cím", title: "Hagyja üresen, ha megegyezik a 'Megnevezés'-el" },
            ...
            i.editorLocalization.locales.id = {
                ...
                ts: { selectPage: "Pilih halaman untuk dicoba:", showInvisibleElements: "Tampilkan elemen tak terlihat", emptySurveyText: "Tidak ada halaman atau pertanyaan yang tersedia di survei ini." },
                validators: { answercountvalidator: "jumlah jawaban", emailvalidator: "surel", expressionvalidator: "ekspresi", numericvalidator: "numerik", regexvalidator: "ekspresi reguler", textvalidator: "teks" },
                triggers: { completetrigger: "selesaikan survei", setvaluetrigger: "atur nilai", copyvaluetrigger: "salin nilai", runexpressiontrigger: "jalankan ekspresi", visibletrigger: "ubah visibilitas" },
                p: {
                    name: "nama",
                    title: { name: "judul", title: "Biarkan kosong, jika sama dengan 'Nama'" },
            ...
            i.editorLocalization.locales.it = {
                survey: {
                    ...
                    license: "È necessario acquistare una licenza per sviluppatori per utilizzare Survey Creator nella propria applicazione.",
                },
                qt: {
                    default: "Default",
                ...
                pe: {
                    ...
                    page: { maxTimeToFinish: "Tempo massimo per terminare la pagina (in secondi)" },
                    ...
                    surveyvalidator: { text: "Messaggio di errore", expression: "Espressione di convalida" },
                    ...
                    logoPositions: { none: "Rimuovi logo", left: "Sinistra", right: "Destra", top: "In alto", bottom: "In basso" },
                    tabs: {
                        general: "Generale",
                        fileOptions: "Opzioni",
                        html: "Modifica Html",
                ...
                pv: {
                    ...
                    panelsState: { default: "Gli utenti non possono espandere o comprimere i pannelli", collapsed: "Tutti i pannelli sono compressi", expanded: "Tutti i pannelli sono estesi" },
                },
                op: {
                    empty: "è vuoto",
                ...
                ts: { selectPage: "Seleziona la pagina da testare:", showInvisibleElements: "Mostra elementi nascosti" },
                validators: { answercountvalidator: "Numero risposte", emailvalidator: "E-mail", expressionvalidator: "Espressione", numericvalidator: "Numerico", regexvalidator: "Regex", textvalidator: "Testo" },
                triggers: {
                ...
                p: {
                    title: { name: "Titolo", title: "Lascialo vuoto, se è uguale a 'Nome'" },
            ...
            i.editorLocalization.locales.ja = {
                ...
                p: { title: { title: "「名前」と同じ場合は空白のままにしてください" } },
                pe: {
                    ...
                    locale: "デフォルトの言語",
                    logoPosition: "ロゴの位置",
                    logoPositions: { bottom: "下に", left: "左", none: "ロゴを削除", right: "右", top: "上に" },
                    maxCount: "最大数",
                    maxLength: "最大長",
                ...
                triggers: { completetrigger: "アンケートを完了", copyvaluetrigger: "値をコピー", runexpressiontrigger: "数式を実行", setvaluetrigger: "値を設定", skiptrigger: "質問へスキップ", visibletrigger: "可視性を変更 (非推奨)" },
                ts: { selectPage: "それをテストするためのページを選択:", showInvisibleElements: "不可視エレメントを表示" },
                validators: { answercountvalidator: "答えの数", emailvalidator: "メール", expressionvalidator: "表現", numericvalidator: "数字の", regexvalidator: "正規表現", textvalidator: "テキスト" },
            };
            i.editorLocalization.locales.ko = {
                survey: {
                    edit: "편집",
                    dropQuestion: "왼쪽 도구상자에서 문항 유형을 끌어다 놓으십시오.",
					addLogicItem: "규칙을 생성해 설문 흐름을 변경 하십시오.",
                    copy: "복사",
                    duplicate: "문항 복제",
                    addToToolbox: "도구상자에 추가",
                    deletePanel: "패널 삭제",
                    deleteQuestion: "문항 삭제",
                    convertTo: "다음으로 변경",
                    drag: "항목 끌어오기",
                },
                qt: {
                    ...
                    html: "HTML",
                    matrix: "표 형(단건 선택)",
                    matrixdropdown: "표 형(복수건 선택)",
                    matrixdynamic: "표 형 (행 추가가능)",
                ...
                ed: {
                    ...
                    generateReadableJSON: "읽기좋은 JSON 데이터 생성",
                    toolbox: "도구상자",
                    ...
                    saving: "저장중",
                    saved: "저장됨",
					surveyPlaceHolder: "항목이 하나도 없습니다. 도구상자에서 항목을 끌어다 놓거나, 아래 버튼을 클릭 해서 항목을 추가 하십시오.",
					addNewQuestion: "항목 추가",
					selectPage: "페이지를 선택 하십시오..",
					htmlPlaceHolder: "HTML 소스 입력",
					panelPlaceHolder: "도구상자에서 문항 유형을 끌어다 놓으십시오.",
					surveyPlaceHolder: "설문이 비어 있습니다. 도구상자에서 문항 유형을 끌어다 놓거나 아래 버튼을 누르십시오.",
					addNewTypeQuestion: "Add {0}",
					chooseLogoPlaceholder: "[LOGO]",
					auto: "auto",
                        lg: {
                            addNewItem: "규칙을 추가 하십시오.",
                            empty_tab: "규칙을 만들어 설문 흐름을 제어 하십시오.",
                            page_visibilityName: "페이지를 보이거나 숨깁니다.",
                            page_enableName: "페이지를 활성화하거나 비활성화 합니다.",
                            panel_visibilityName: "패널을 보이거나 숨깁니다.",
                            panel_enableName: "패널을 활성화하거나 비활성화 합니다.",
                            question_visibilityName: "문항을 보이거나 숨깁니다.",
                            question_enableName: "문항을 활성화 하거나 비활성화 합니다.",
                            question_requireName: "문항을 필수로 만듭니다.",
                            column_visibilityName: "컬럼을 보이거나 숨깁니다.",
                            column_enableName: "컬럼을 활성화 하거나 비활성화 합니다.",
                            column_requireName: "컬럼을 필수로 만듭니다.",
                            trigger_completeName: "설문을 완료 시킵니다.",
                            trigger_setvalueName: "응답값을 세팅합니다.",
                            trigger_copyvalueName: "응답값을 복사합니다.",
                            trigger_skipName: "특정 문항으로 이동합니다.",
                            trigger_runExpressionName: "수식을 실행 합니다.",
                            completedHtmlOnConditionName: '"설문 종료" 페이지를 설정합니다.',
                            page_visibilityDescription: "Make the page visible when the logic expression returns true. Otherwise keep it invisible.",
                            panel_visibilityDescription: "Make the panel visible when the logic expression returns true. Otherwise keep it invisible.",
                            panel_enableDescription: "Make the panel, and all elements inside it, enable when the logic expression returns true. Otherwise keep them disabled.",
                            question_visibilityDescription: "Make the question visible when the logic expression returns true. Otherwise keep it invisible.",
                            ...
                            showAllQuestions: "모든 문항",
                            showAllActionTypes: "모든 액션 유형",
                            conditions: "조건",
                            actions: "액션",
                            expressionEditorTitle: "조건 정의",
                            actionsEditorTitle: "액션 정의",
                            deleteAction: "액션 삭제",
                            addNewAction: "액션 추가",
                            selectedActionCaption: "액션을 선택하십시오...",
                ...
                pe: {
                    ...
                    valueName: "값 이름",
                    titleName: "제목 이름",
					imageLinkName: "이어지는 JSON필드에서 이미지 주소를 얻어옵니다.",
                    allowEmptyResponse: "응답 없음 허용",
                    titlePlaceholder: "제목",
                    surveyTitlePlaceholder: "설문 제목",
                    pageTitlePlaceholder: "페이지 {num}",
                    descriptionPlaceholder: "설명",
                    surveyDescriptionPlaceholder: "설명",
                    pageDescriptionPlaceholder: "설명",					
                ...
                validators: { answercountvalidator: "답 개수", emailvalidator: "이메일", expressionvalidator: "표현식", numericvalidator: "숫자", regexvalidator: "정규식", textvalidator: "텍스트" },
                triggers: { completetrigger: "설문 완료", setvaluetrigger: "값 설정", visibletrigger: "선명도 변경" },
                p: {
                    name: "이름",
                    title: { name: "제목", title: "'이름'과 같은 경우 비워 둡니다." },
            ...
            i.editorLocalization.locales.ms = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Alih keluar logo", left: "Kiri", right: "Kanan", top: "Di atas", bottom: "Di bawah" },
                    tabs: {
                        general: "Umum",
                        fileOptions: "Pilihan",
                        html: "Editor HTML",
                ...
                ts: { selectPage: "Pilih halaman untuk mengujinya:", showInvisibleElements: "Pilih elemen tersembunyi" },
                validators: { answercountvalidator: "kiraan jawapan", emailvalidator: "e-mel", expressionvalidator: "ekspresi", numericvalidator: "numerik", regexvalidator: "regex", textvalidator: "teks" },
                triggers: {
                ...
                p: {
                    name: "nama",
                    title: { name: "tajuk", title: "Biarkan kosong, jika sama seperti 'Nama'" },
            ...
            i.editorLocalization.locales.nb = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Fjern logo", left: "Venstre", right: "Høyre", top: "Topp", bottom: "Bunn" },
                    tabs: {
                        general: "Generelt",
                        fileOptions: "Valg",
                        html: "HTML-editor",
                ...
                ts: { selectPage: "Velg side:", showInvisibleElements: "Vis usynlige elementer" },
                validators: { answercountvalidator: "antall svar", emailvalidator: "e-post", expressionvalidator: "formel", numericvalidator: "numerisk", regexvalidator: "regex", textvalidator: "tekst" },
                triggers: {
                ...
                p: {
                    name: "name",
                    title: { name: "title", title: "La den være tom, dersom den skal være samme som navnet" },
                    navigationButtonsVisibility: "navigationButtonsVisibility",
                    questionsOrder: "questionsOrder",
                    maxTimeToFinish: "maxTimeToFinish",
                    visible: "visible",
            ...
            i.editorLocalization.locales.fa = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "حذف لوگو", left: "چپ", right: "راست", top: "بخش بالا", bottom: "بخش پایین" },
                    tabs: {
                        general: "عمومی",
                ...
                ts: { selectPage: "صفحه ای را برای آزمایش انتخاب کنید:", showInvisibleElements: "نمایش المان های مخفی" },
                validators: { answercountvalidator: "تعداد پاسخ", emailvalidator: "ایمیل", expressionvalidator: "عبارت", numericvalidator: "عدد", regexvalidator: "regex", textvalidator: "متن" },
                triggers: { completetrigger: "تکمیل نظرسنجی", setvaluetrigger: "تنظیم مقدار", copyvaluetrigger: "کپی مقدار", skiptrigger: "رد کردن سوال ", runexpressiontrigger: "اجرای عبارت", visibletrigger: "تغییر وضعیت دیده شدن" },
                pehelp: {},
                p: {
                    name: "نام",
                ...
                pel: { isRequired: "اجباری؟" },
            };
            i.editorLocalization.locales.pl = {
                survey: { edit: "Edytuj", dropQuestion: "Przeciągnij pytanie.", copy: "Kopiuj", addToToolbox: "Dodaj do palety", deletePanel: "Usuń panel", deleteQuestion: "Usuń pytanie", convertTo: "Konwertuj na" },
                qt: {
                ...
                validators: { answercountvalidator: "answer count", emailvalidator: "e-mail", numericvalidator: "numeric", regexvalidator: "regex", textvalidator: "text" },
                triggers: { completetrigger: "complete survey", setvaluetrigger: "set value", visibletrigger: "change visibility" },
                p: { name: "nazwa", title: { name: "tytuł", title: "Pozostaw pusty, jeśli ma być taki sam, jak 'Nazwa'" }, page_title: { name: "tytuł", title: "Tytuł sekcji" } },
            };
            i.editorLocalization.locales.pt = {
                ...
                ts: { selectPage: "Selecione a página para testar:", showInvisibleElements: "Mostrar elementos invisíveis" },
                validators: { answercountvalidator: "contador de respostas", emailvalidator: "e-mail", expressionvalidator: "expressão", numericvalidator: "numérico", regexvalidator: "regex", textvalidator: "texto" },
                triggers: { completetrigger: "completar pesquisa", setvaluetrigger: "definir valor", copyvaluetrigger: "copiar valor", runexpressiontrigger: "rodar expressão", visibletrigger: "alterar visibilidade" },
                p: {
                    name: "nome",
            ...
            i.editorLocalization.locales.ru = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Разместить логотип", left: "Слева", right: "Справа", top: "Сверху", bottom: "Снизу" },
                    tabs: {
                        general: "Общие",
                ...
                ts: { selectPage: "Выберите страницу, чтобы проверить это", showInvisibleElements: "Показывать скрытые элементы" },
                validators: { answercountvalidator: "Количество ответов", EmailValidator: "Email", expressionvalidator: "Выражение", numericvalidator: "Число", regexvalidator: "Регулярное выражение", textvalidator: "Текст" },
                triggers: {
                ...
                p: {
                    name: "Название",
                    title: { name: "Название", title: "Оставьте его пустым, если оно такое же, как 'Название'" },
            ...
            i.editorLocalization.locales["zh-cn"] = {
                ...
                ts: { selectPage: "选择测试页", showInvisibleElements: "显示隐藏元件" },
                validators: { answercountvalidator: "数量检查", emailvalidator: "Email", expressionvalidator: "公式", numericvalidator: "数字", regexvalidator: "正则表达式", textvalidator: "文本" },
                triggers: { completetrigger: "完成问卷", setvaluetrigger: "设置问题值", copyvaluetrigger: "复制值", runexpressiontrigger: "运行公式", visibletrigger: "修改可见性" },
                p: {
                    name: "名字",
            ...
            i.editorLocalization.locales.sk = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Odstrániť logo", left: "Vľavo", right: "Vpravo", top: "V hornej časti", bottom: "V spodnej časti" },
                    tabs: {
                        general: "Všeobecné",
                        fileOptions: "Možnosti",
                        html: "Editor Html",
                ...
                ts: { selectPage: "Vybrať stránku na testovanie:", showInvisibleElements: "Zobraziť neviditeľné prvky" },
                validators: { answercountvalidator: "počet odpovedí", emailvalidator: "e-mail", expressionvalidator: "výraz", numericvalidator: "číslo", regexvalidator: "regex", textvalidator: "text" },
                triggers: {
                ...
                p: {
                    name: "názov",
                    title: { name: "titul", title: "Nechajte prázdne, ak sa zhoduje s menom" },
            ...
            i.editorLocalization.locales.es = {
                ...
                pe: {
                    ...
                    conditionHelp: "Por favor ingrese una expresión booleana.Debe devolverse verdadero para mantener visible la pregunta / página.Por ejemplo: {pregunta1} = 'value1' o ({pregunta2} * {pregunta4}> 20 y {pregunta3} <5)",
                    expressionHelp:
                    ...
                    conditionShowMoreUrl: "https://surveyjsIo/documentation/libraryParametro?Id =PreguntaYParámetro =VisibleSi",
                    ...
                    logoPositions: { none: "Eliminar logo", left: "Izquierda", right: "Derecha", top: "En la parte superior", bottom: "En la parte inferior" },
                    tabs: {
                        general: "General",
                    ...
                    keyboardMoveItemsTip: "Presione ALT Plus flecha hacia arriba o flecha hacia abajo para mover el artículo",
                    triggerOn: "En",
                ...
                ts: { selectPage: "Seleccione la página para probarlo:", showInvisibleElements: "Mostrar elementos invisibles" },
                validators: { answercountvalidator: "Cantidad de respuestas", emailvalidator: "Email", expressionvalidator: "expresión", numericvalidator: "numérica", regexvalidator: "regex", textvalidator: "texto" },
                triggers: {
                ...
                p: {
                    name: "nombre",
                    title: { name: "título", title: "Dejarlo vacío, si es lo mismo que 'Name'" },
                    ...
                    size: "Tamaño",
                    locale: "lugar",
                    focusFirstQuestionAutomatic: "Colocarse automáticamente en la primera pregunta",
                    completedHtml: "HTML completado",
            ...
            i.editorLocalization.locales.sv = {
                ...
                pe: {
                    ...
                    conditionHelp: "Skriv in ett boolsk uttryck. Det bör returnera SANT för att göra frågan/sidan synlig. Till exempel: {question1} = 'value1' or ({question2} * {question4}  > 20 and {question3} < 5)",
                ...
                ts: { selectPage: "Välj sida för att testa den:", showInvisibleElements: "Visa osynliga element" },
                validators: { answercountvalidator: "answer count", emailvalidator: "e-mail", expressionvalidator: "expression", numericvalidator: "numeric", regexvalidator: "regex", textvalidator: "text" },
                triggers: { completetrigger: "Enkät slutförd", setvaluetrigger: "Sätt värde", copyvaluetrigger: "Kopiera värde", runexpressiontrigger: "Kör uttryck", visibletrigger: "Ändra synlighet" },
                p: {
                    name: "name",
                    title: { name: "title", title: "Lämna den tom, ifall det är samma som 'Name'" },
                    navigationButtonsVisibility: "navigationButtonsVisibility",
                    questionsOrder: "questionsOrder",
                    maxTimeToFinish: "maxTimeToFinish",
                    visible: "visible",
            ...
            i.editorLocalization.locales.tg = {
                ...
                pe: {
                    ...
                    conditionHelp: "Илтимос, ифодаи мантиқиро ворид кунед. Бояд қиммати 'true' баргардонад, барои савол/саҳифа нобаён бошад, мисол:.. {Савол1} = 'қиммат1' ё ({Савол2} * {Савол4}> 20 ва {Савол3} <5)",
                    ...
                    logoPositions: { none: "Разместить логотип", left: "Аз чап", right: "Дар тарафи рост", top: "Аз боло", bottom: "Аз поён" },
                    tabs: {
                        general: "Умумӣ",
                ...
                ts: { selectPage: "Саҳифаро интихоб кунед, барои санҷидани ин:", showInvisibleElements: "Нишон додани элементҳои пинҳон" },
                validators: { answercountvalidator: "Шумораи ҷавобҳо", EmailValidator: "Email", expressionvalidator: "Ишора", numericvalidator: "Рақам", regexvalidator: "Ишораи регулярӣ", textvalidator: "Матн" },
                triggers: {
                ...
                p: {
                    name: "Ном",
                    title: { name: "Ном", title: "Холӣ гузоред, агар номи ӯ ҳамчун 'Ном' бошад" },
            ...
            i.editorLocalization.locales["zh-tw"] = {
                survey: { edit: "編輯", dropQuestion: "請將問題放置於此", copy: "複製", addToToolbox: "添加到工具箱", deletePanel: "刪除面板", deleteQuestion: "刪除題目", convertTo: "轉變為" },
                qt: {
                    checkbox: "多項選擇",
                    comment: "多行文本框",
                    dropdown: "下拉框",
                ...
                op: { empty: "為空", notempty: "不為空", equal: "等於", notequal: "不等於", contains: "包含", notcontains: "不包含", greater: "大於", less: "小於", greaterorequal: "大於等於", lessorequal: "小於等於" },
                ew: {
                ...
                validators: { answercountvalidator: "數量檢查", emailvalidator: "Email", numericvalidator: "數字", regexvalidator: "正則表達式", textvalidator: "文本" },
                triggers: { completetrigger: "完成問卷", setvaluetrigger: "設置問題值", visibletrigger: "修改可見性" },
                p: {
                    commentText: "備註文本",
                    choices: "選項",
                    choicesByUrl: "Url選項",
                    ...
                    isSinglePage: "在一個頁面上展示所有元素",
                    name: "名字",
                    title: { name: "標題", title: "如果與名字相同，請設置為空值" },
                    survey_title: { name: "標題", title: "問卷標題在每頁上都會顯示" },
                    page_title: { name: "標題", title: "頁面標題" },
                },
            };
            i.editorLocalization.locales.tr = {
                ...
                pe: {
                    ...
                    logoPositions: { none: "Logoyu kaldır", left: "Sol", right: "Sağ", top: "Üstte", bottom: "Altta" },
                    tabs: {
                        general: "Genel",
                ...
                ts: { selectPage: "Test edilecek sayfayı seçin:", showInvisibleElements: "Görünmez öğeleri göster" },
                validators: { answercountvalidator: "cevap sayısı", emailvalidator: "e-mail", expressionvalidator: "ifade", numericvalidator: "numerik", regexvalidator: "regex", textvalidator: "text" },
                triggers: {
                ...
                p: {
                    name: "adı",
                    title: { name: "başlık", title: "'Ad' ile aynıysa boş bırakın" },
