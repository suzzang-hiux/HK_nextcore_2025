...
(function ($) {
    ...
    w2grid.prototype = {
        ...
        selectAll: function () {
            ...
            if (sel.length == 1) this.toolbar.enable.apply(this.toolbar, ['w2ui-edit'].concat((this.toolbar.oneBtns||[])));  else this.toolbar.disable.apply(this.toolbar, ['w2ui-edit'].concat((this.toolbar.oneBtns||[])));
            if (sel.length >= 1) this.toolbar.enable.apply(this.toolbar, ['w2ui-delete'].concat((this.toolbar.selectBtns||[]))); else this.toolbar.disable.apply(this.toolbar, ['w2ui-delete'].concat((this.toolbar.selectBtns||[])));
            this.addRange('selection');
            $('#grid_'+ this.name +'_check_all').prop('checked', true);
            // event after
            this.trigger($.extend(edata, { phase: 'after' }));
        ...
        selectNone: function () {
            ...
            sel.indexes = [];
            sel.columns = {};
            this.toolbar.disable.apply(this.toolbar, 
                                        ['w2ui-edit'].concat((this.toolbar.oneBtns||[]))
                                    .concat( 
                                        ['w2ui-delete'].concat((this.toolbar.selectBtns||[]))
                                    ));
            this.removeRange('selection');
            $('#grid_'+ this.name +'_check_all').prop('checked', false);
            // event after
